...
Includes Easy, Medium, and Hard timed modes with Quick 5, Sprint 10, Gauntlet 25, and up-to-999-level Endless runs. Every 10-level stage gets faster and refreshes the lifelines. Players earn speed and streak bonuses, discover a daily featured wiki for double points, build a learned-project collection, and track a knowledge score across projects and categories.
...
- `token-quiz-complete` with `{ score, levels, difficulty, category, knowledgeScore, discoveredProjects, discoveredCategories }`
